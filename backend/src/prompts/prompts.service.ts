...
export class PromptsService {
  ...
  private async generateSections(text: string): Promise<{ title: string; content: string }[]> {
    // Define our sections with enhanced HTML content that form a complete website
    // Each section follows a consistent structure and styling pattern
...
<nav class="bg-amber-800 text-white">
  <div class="container mx-auto px-4 py-3 flex items-center justify-between">
    <div class="flex items-center space-x-2">
      ...
      <span class="text-xl font-bold">Bakery</span>
    </div>
...
<section id="home" class="py-20 bg-amber-50">
  <div class="container mx-auto px-4 text-center">
    <div class="bg-white bg-opacity-80 p-8 rounded-lg max-w-2xl mx-auto shadow-lg">
      <h1 class="text-4xl md:text-5xl font-bold text-amber-800 mb-4">Bakery</h1>
...
<section id="about" class="py-16 bg-white">
  <div class="container mx-auto px-4">
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-amber-800 mb-4">About Bakery</h2>
    ...
    <div class="flex flex-col md:flex-row justify-between">
      ...
      <div class="mb-8 md:mb-0 md:w-1/4">
        <div class="flex items-center mb-4">
          ...
          <span class="text-xl font-bold text-amber-200 ml-2">Bakery</span>
        </div>
